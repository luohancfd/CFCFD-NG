...
def objective_function(y):
    ...
    run_command('./run-mpi-block-marching-mode.sh')
    ...
    for j in range(len(data['pos.y'])):
        ...
        # TODO -> I believe that we can improve this by looking at mu_t.
        if j == 0: 
...
if __name__ == '__main__':
    print "Begin the optimisation of the T4 Mach 7 nozzle..."
    print "---------------------------------------------------"
    ...
    #dx = [0.003, 0.003, 0.003, 0.005, 0.005, 0.005, 0.005, 0.005]
