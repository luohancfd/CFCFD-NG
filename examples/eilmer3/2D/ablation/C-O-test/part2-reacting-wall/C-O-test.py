...
initial = ExistingSolution(rootName="CO-test", solutionWorkDir="../part1-fixedT/", nblock=4, tindx=0020)
#
...
blk_0 = SuperBlock2D(make_patch(north,east,south,west), nni=nnx, nnj=nny, nbi=nbx, nbj=nby,
                bc_list=[ExtrapolateOutBC(), UserDefinedBC(filename="udf-char-mass-in.lua",sets_conv_flux=1,is_wall=1), SlipWallBC(), SupInBC(inflow)],
