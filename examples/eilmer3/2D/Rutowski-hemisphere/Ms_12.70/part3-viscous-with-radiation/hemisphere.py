...
# radiation model 
# NOTE: update frequency of 0 means e3mpi.exe and e3shared.exe will not try and compute  
#       the radiation source term - we leave this to e3rad.exe
select_radiation_model(input_file="rad-model.lua", update_frequency=0, scaling=True)
...
if transfer_solution:
    initial = ExistingSolution(rootName="hemisphere", solutionWorkDir="../part2-viscous/", nblock=4, tindx=5)
else:
...
gdata.dt_plot = Rn * 1 / u_inf    # 1 solution per body length
