...
-- Effects of hydrogen impurities on shock structure and stability in ionizing 
-- monatomic gases. Part 1. Argon
...
reaction{
   'Ar + e- <=> Ar+ + e- + e-',
   fr={'Park', A=f*9.039202e11, n=0.867, T_a=132482.8, p_name='e_minus', p_mode='translation', s_p=1.0, q_name='NA', q_mode='NA'},
