...
if __name__ == '__main__':
    print "Begin the optimisation of the X3R Mach 7 nozzle..."
    print "---------------------------------------------------"
    # Basename for file containing Bezier control points
    global basename
    basename = 'Bezier-control-pts-x3r-m7'
    ...
    dx = [0.009, 0.009, 0.015, 0.015, 0.015, 0.015, 0.015]
