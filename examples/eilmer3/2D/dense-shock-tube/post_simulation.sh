...
e3post.py --job=dst --slice-list=":,:,0,0" --output-file=profile.data

# Plot the data along the x-axis.
gnuplot <<EOF
set term postscript eps enhanced 20
set output "cst-p.eps"
set title "Dense gas shock tube at t = 100us"
set xlabel "x, m"
...
set yrange [0:1100]
set key left bottom
plot "profile.data" using 1:20 t 'Eilmer3' with points pt 6, \
