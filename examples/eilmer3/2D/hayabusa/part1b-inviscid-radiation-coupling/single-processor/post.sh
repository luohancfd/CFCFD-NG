...
e3post.py --job=hayabusa --tindx=9999 --slice-list="0,:,0,:"

# 3. Heat flux profile along vehicle surface
e3post.py --job=hayabusa --tindx=9999 --heat-flux-list="0,1,:,:,:"

# 4. Tangent-slab calculation along stagnation streamline
e3post.py --job=hayabusa --tindx=9999 --tangent-slab-list="0,:,0,:"
