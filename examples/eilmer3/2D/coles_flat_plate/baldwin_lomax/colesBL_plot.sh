...
#           02-Oct-2008 Baldwin-Lomax version (doesn't have k-omega properties)
#
...
set key left top
set yrange [0:20.0]
plot "colesBL-ix21.dat" using (\$6):((0.24-\$2)*1000) title "Elmer3", \
...
set key right top
set yrange [0:20.0]
plot "colesBL-ix21.dat" using (\$20):((0.24-\$2)*1000) title "Elmer3", \
...
set key left top
set yrange [0:20.0]
plot "colesBL-ix21.dat" using (\$21/1000):((0.24-\$2)*1000) title "Elmer3", \
...
set key left top
set yrange [0:20.0]
plot "colesBL-ix21.dat" using (\$5*1000):((0.24-\$2)*1000) title "Elmer3", \
...
set yrange [0:20.0]
set xtic 0.0002
plot "colesBL-ix21.dat" using (\$13):((0.24-\$2)*1000) title "Elmer3"
EOF
