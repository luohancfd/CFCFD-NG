...
c = Node(0.25, 0.1, label="c")
d = Node(0.25, 0.0,  label="d")
...
nx = 50; ny = 2
blk_0 = Block2D(make_patch(north0, east0west1, south0, west0), nni=nx/2, nnj=ny,
                fill_condition=high_p, label="driver")
blk_1 = Block2D(make_patch(north1, east1, south1, east0west1), nni=nx, nnj=ny,
                fill_condition=low_p, label="driven")
identify_block_connections()
blk_0.bc_list[WEST] = TransientProfBC(filename="sod-driver-transient-profile-bc.dat", n_profile=2)
