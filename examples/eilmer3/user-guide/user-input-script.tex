...
%
As a motivational example, for MECH4480 students of CFD in particular,
...
The simplest way to define the region is to make a patch with 4 sides
...
Figure~\ref{the-plain-bottle-fig} shows the resulting grid from dividing up 
...
\medskip
Each of the blocks is generated independently og the others.
It is the user's responsibility to ensure that the common defining edges are 
