...
The following text in the input script requests the radiative source terms and heat fluxes
 are recomputed every 100 time steps and directs e3prep to the file \texttt{rad-model.lua} 
 for the details of the desired model:

\topbar\\
\texttt{select\_radiation\_model( input\_file="rad-model.lua", update\_frequency=10 )}\\ \index{select\_radiation\_model}
\bottombar\\

%
The format for the Lua file is give in Section~\ref{}.
