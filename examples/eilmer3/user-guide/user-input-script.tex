...
\item \texttt{viscous\_upwinding}: 1=velocity spatial derivatives are taken from upwind direction, 0=velocity spatial derivatives are averaged over both directions, default value 0.
