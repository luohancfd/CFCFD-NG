...
\texttt{http://www.mech.uq.edu.au/cfcfd/}.\index{Internet address}
...
The \texttt{README.txt} file (Appendix\,\ref{readme-file}) or the corresponding
\texttt{README.html} file in the root directory 
of the source code provides more detail including 
...
The notes in Appendix\,\ref{readme-file} show how to build the Eilmer3 executable for OpenMPI.
...
Usage: e3post.py [--help] [--job=<jobFileName>] [--tindx=<index|all>]
                 ...
                 [--vtk-xml] [--tecplot] [--plot3d] [--prepare-restart]
                 [--put-into-folders]
...
\medskip
Finally, for certain advanced gas models (like multi-temperature gas mixtures), the only
means to configure these models is via the preparation of a Lua-style configuration
file by hand.
...
\begin{itemize}
  ...
  \item \texttt{assume\_same\_grid}: decide how to locate corresponding cells
     \begin{itemize}
        \item[\texttt{0}]: searches for corresponding cells.
        ...
        \item[\texttt{1}]: omits the search for the corresponding cell.
                Definitely the option for the impatient.
     \end{itemize}
...
\medskip
If you look into the file \texttt{cfcfd2/lib/geometry2/source/geom.hh}, you will see that
...
These may be found in the directory \texttt{cfcfd2/lib/geometry2/source/}.
...
at get applied to the subblocks in the respective index directions.
...
\bibliography{bibtex/pj,bibtex/computing,bibtex/gas_dynamic,bibtex/adm,bibtex/gas}

\cleardoublepage
\appendix

\section{README.txt: Instructions for installation}
\label{readme-file}\index{README}\index{Installation}
%
The latest version of this file should be in the root directory of the package
of source files.
This loation is typically \texttt{\$HOME/cfcfd2} on our development machines.\\
\topbar
\lstinputlisting[language={}]{../../../README.txt}
\bottombar
