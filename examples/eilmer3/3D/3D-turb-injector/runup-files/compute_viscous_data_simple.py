...
T_w = 276.17        # Temperature at wall, K
rho_inf = 0.352    # free stream density, kg/m^3
u_inf = 671.92     # free stream velocity, m/s
mu = sutherland.mu(T_w, "Air")  # fluid viscosity at wall

print "Begin compute_viscous_data_simple.py"

infile = open("./flat_runup-y-wall.dat", "r")
