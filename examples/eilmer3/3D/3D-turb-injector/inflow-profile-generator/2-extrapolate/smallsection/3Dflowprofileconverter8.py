...
ncelly = 5     # Number of cells in y direction in 3D extrapolation
...
outfile1 = open("3Dinfilesmalllower1.dat", "w")
outfile2 = open("3Dinfilesmalllower2.dat", "w")
outfile3 = open("3Dinfilesmalllower3.dat", "w")
outfile4 = open("3Dinfilesmalllower4.dat", "w")
outfile5 = open("3Dinfilesmallupper1.dat", "w")
outfile6 = open("3Dinfilesmallupper2.dat", "w")
outfile7 = open("3Dinfilesmallupper3.dat", "w")
outfile8 = open("3Dinfilesmallupper4.dat", "w")
