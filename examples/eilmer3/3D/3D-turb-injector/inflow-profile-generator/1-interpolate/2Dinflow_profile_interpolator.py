...
lowresIN = open("./inject-input-slice.dat", "r")	#CHANGE AS REQUIRED
highresIN = open("./flat_runup-endghost2.dat","r")	#CHANGE AS REQUIRED
...
outfile = open("interpolated_profile_endghost2.dat", "w")
