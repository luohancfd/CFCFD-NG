...
function ghost_cell(args)
   ...
   r = math.sqrt(y*y + z*z)  -- r is radial coordinate in y,z-plane
   sin_theta = -y/r          -- theta is circumferential coordinate in y,z-plane
   cos_theta = z/r
   ...
   ghost.v = vel*math.sin(alpha)*cos_theta   -- y-velocity [m/s]
   ghost.w = vel*math.sin(alpha)*sin_theta   -- z-velocity [m/s]
