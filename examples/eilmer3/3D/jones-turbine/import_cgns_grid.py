...
#
            ...
            if (familyName.find("OUTLET") >= 0): 
                bc['type'] = "outlet"                
                cgnsData['bcs'].append(bc)
            elif (familyName.find("INLET") >= 0): 
                bc['type'] = "inlet"                
                cgnsData['bcs'].append(bc)
            elif (familyName.find("PERIODIC") >= 0): 
                bc['type'] = "periodic"                
                cgnsData['bcs'].append(bc)
            elif (familyName.find("BLADE") >= 0): 
                bc['type'] = "wall"                
#                cgnsData['bcs'].append(bc)
            elif (familyName.find("SHROUD") >= 0): 
                bc['type'] = "wall"                
#                cgnsData['bcs'].append(bc)
            elif (familyName.find("HUB") >= 0): 
                bc['type'] = "wall"                
#                cgnsData['bcs'].append(bc)
            elif (familyName.find("ORPHAN") >= 0): 
                bc['type'] = "internal"                
#               do not add
            else: 
                print "WARNING: Unknown boundary condition: " , familyName
