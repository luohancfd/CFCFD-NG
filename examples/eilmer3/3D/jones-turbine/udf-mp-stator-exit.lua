-- udf-mp-stator-exit.lua
-- Lua script for the user-defined mixing plane for radial turbine
-- called by the UserDefinedGhostCell BC.
-- Paul Petrie-Repar April 2010
...
function get_average_pressure()
   ...
   for k = 2, nnk+1 do
      ...
      p_sum = 0
      for j = 2, nnj+1 do 
   	 cell_flow = sample_flow(block_id+1, i_mp, j, k)
