...
time ./simple_reactor.py \
    --type=cvfm \
    --gas=thermally-perfect-drm22.lua \
    --chem=drm22.lua \
    --T=2000 \
    --p=1 \
...
set output "cvfm-drm22-2000K-1bar-T.eps"
#
set mxtics 5
...
#
plot 'cvfm-sp-output.dat' u 1:4 w l lt 1 t 'simple_reactor w/ DRM22'
EOF

gnuplot <<EOF
set terminal postscript eps 20
set output "cvfm-drm22-2000K-1bar-X.eps"
#
set mxtics 5
set xtics 0,1e-4,4e-4
set format x '%1.0e'
...
set key bottom right
#
plot 'cvfm-sp-output.dat' u 1:7 w l lt 1 t 'simple_reactor w/ DRM22', \
...
gnuplot <<EOF
set terminal postscript eps 20
set output "cpfm-drm22-2000K-1bar-T.eps"
#
set mxtics 5
set xtics 0,1e-4,4e-4
#set xrange[0:1e-2]
...
plot 'drm22-chemkin-output-2000K-1bar.dat' u 1:2 w l lt 1 t 'Chemkin-II w/ DRM22', \
     'cpfm-sp-output.dat' u 1:4 w l lt 2 t 'o/s simple_reactor w/ DRM22'
EOF

gnuplot <<EOF
set terminal postscript eps 20
set output "cpfm-drm22-2000K-1bar-X.eps"
#
set mxtics 5
set xtics 0,1e-4,4e-4
set format x '%1.0e'
...
set key bottom right
#
plot 'drm22-chemkin-output-2000K-1bar.dat' u 1:3 w l lt 1 t 'Chemkin-II', \
    ...
    '' u 1:22 w l lt 1 notitle, \
    '' u 1:23 w l lt 1 notitle, \
    'cpfm-sp-output.dat' u 1:7 w l lt 2 t 'simple_reactor w/ DRM22', \
