...
time ./simple_reactor.py \
    --type=cvfm \
    --gas=thermally-perfect-jazbec-etal.lua \
    --chem=jazbec-etal.lua \
    --T=2000 \
    --p=1 \
...
set output "cvfm-jazbec-etal-2000K-1bar-T.eps"
#
set mxtics 5
...
#
plot 'cvfm-sp-output.dat' u 1:4 w l lt 1 t 'simple_reactor w/ jazbec-etal'
EOF

gnuplot <<EOF
set terminal postscript eps 20
set output "cvfm-jazbec-etal-2000K-1bar-X.eps"
#
set mxtics 5
set xtics 0,1e-4,4e-4
set format x '%1.0e'
...
set key bottom right
#
plot 'cvfm-sp-output.dat' u 1:7 w l lt 1 t 'simple_reactor w/ jazbec-etal', \
...
gnuplot <<EOF
set terminal postscript eps 20
set output "cpfm-jazbec-etal-2000K-1bar-T.eps"
#
set mxtics 5
set xtics 0,1e-4,4e-4
#set xrange[0:1e-2]
...
plot 'jazbec-etal-chemkin-output-2000K-1bar.dat' u 1:2 w l lt 1 t 'Chemkin-II w/ jazbec-etal', \
     'cpfm-sp-output.dat' u 1:4 w l lt 2 t 'o/s simple_reactor w/ jazbec-etal'
EOF

gnuplot <<EOF
set terminal postscript eps 20
set output "cpfm-jazbec-etal-2000K-1bar-X.eps"
#
set mxtics 5
set xtics 0,1e-4,4e-4
set format x '%1.0e'
...
set key bottom right
#
plot 'jazbec-etal-chemkin-output-2000K-1bar.dat' u 1:3 w l lt 1 t 'Chemkin-II', \
    ...
    '' u 1:17 w l lt 1 notitle, \
    '' u 1:18 w l lt 1 notitle, \
    'cpfm-sp-output.dat' u 1:7 w l lt 2 t 'simple_reactor w/ jazbec-etal', \
