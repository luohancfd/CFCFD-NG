# File: x2_air-80-he-no-secondary-driver.py
# This is an L1d simulation of the X2 expansion tube without 
# a secondary driver section and with an 80%He/20%Ar primary driver
# and matching orifice plate.
# Condition is the slower air condition used by Umar Sheikh.
