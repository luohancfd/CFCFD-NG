...
set output "Intensity-spectra.eps"
set size 1.5,1.0
...
plot 'intensity_spectra.txt' using ($1):(($2)*100/STATS_max) with lines lw 1 lt 1 t 'Photaura', \
     'LIFBASE-spectra/OH_AX_res_2_5_3000K.mod' using ($1/10):($2) with lines lw 1 lt 1 lc 3 t 'LIFBASE', 'SPARTAN-spectra/SPARTAN_data.txt' using ($1):($2) with lines lw 1 lt 1 lc 4 t 'SPARTAN'
