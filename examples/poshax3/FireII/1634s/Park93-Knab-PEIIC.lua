...
--   07-Aug-2013: - Knab VCV model for dissociation and neutral exchange reactions
...
reaction{
   'N2 + M <=> N + N + M',
   fr={'Knab_et_al', A=7.0e21, n=-1.60, T_a=113200.0, v_name='N2', U=113200.0*fU, alpha=alpha},
   chemistry_energy_coupling={ {species='N2', mode='vibration', model='Knab_et_al', A=113200, U=113200.0*fU, alpha=alpha} },
...
reaction{
   'O2 + M <=> O + O + M',
   fr={'Knab_et_al', A=2.0e21, n=-1.5, T_a=59500.0, v_name='O2', U=59500.0*fU, alpha=alpha},
   chemistry_energy_coupling={ {species='O2', mode='vibration', model='Knab_et_al', A=59500.0, U=59500.0*fU, alpha=alpha} },
...
reaction{
   'NO + M <=> N + O + M',
   fr={'Knab_et_al', A=5.0e15, n=0.0, T_a=75500.0, v_name='NO', U=75500.0*fU, alpha=alpha},
   chemistry_energy_coupling={ {species='NO', mode='vibration', model='Knab_et_al', A=75500.0, U=75500.0*fU, alpha=alpha} },
...
reaction{
   'NO + O <=> O2 + N',
   fr={'Knab_et_al', A=8.4e12, n=0.0, T_a=19450.0, v_name='NO', U=75500.0*fU, alpha=alpha},
   chemistry_energy_coupling={ {species='NO', mode='vibration', model='Knab_et_al', A=19450.0, U=75500.0*fU, alpha=alpha},
                               {species='O2', mode='vibration', model='Knab_et_al', A=19450.0, U=59500.0*fU, alpha=alpha} },
   ec={model='from CEA curves',iT=0}
}

reaction{
   'N2 + O <=> NO + N',
   fr={'Knab_et_al', A=6.4e17, n=-1.0, T_a=38400.0, v_name='N2', U=113200.0*fU, alpha=alpha},
   chemistry_energy_coupling={ {species='NO', mode='vibration', model='Knab_et_al', A=38400.0,  U=75500.0*fU, alpha=alpha},
                               {species='N2', mode='vibration', model='Knab_et_al', A=38400.0, U=113200.0*fU, alpha=alpha} },
   ec={model='from CEA curves',iT=0}
}
