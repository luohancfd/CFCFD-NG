...
This is a two temperature air example for the poshax_python program
using some proposed X2 conditions.

A one temperature version of this example is also available.
