...
if USING_PARK:
    r0 = make_reaction("N2 + N2 <=> N + N + N2",
                       fr=GA_forward( 3.7e21, -1.6, 113200.0 ),
                       reac_type="Dissociation" )
    r1 = make_reaction( "N2 + N <=> N + N + N",
                        fr=GA_forward( 1.66e22, -1.6, 113200.0 ),
                        reac_type="Dissociation" )
    r2 = make_reaction( "N2 + e- <=> N + N + e-",
                        fr=GA_forward( 8.3e24, -1.6, 113200.0 ),
                        reac_type="Dissociation" )
...
if USING_GOKCEN:
    r0 = make_reaction("N2 + N2 <=> N + N + N2",
                       fr=GA_forward( 7.0e21, -1.6, 113200.0 ),
                       reac_type="Dissociation" )
    r1 = make_reaction( "N2 + N <=> N + N + N",
                        fr=GA_forward( 3.0e22, -1.6, 113200.0 ),
                        reac_type="Dissociation" )
    r2 = make_reaction( "N2 + e- <=> N + N + e-",
                        fr=GA_forward( 3.0e24, -1.6, 113200.0 ),
                        reac_type="Dissociation" )
    r3 = make_reaction( "N + N <=> N2+ + e-",
