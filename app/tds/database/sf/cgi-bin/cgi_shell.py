...
versionstring = 'Version 1.0.1 17th July 2004'
...
<input name=cmd value=\"%s\" type=text><BR>
...
"""
TODO/ISSUES
If the command typed has \" in it - it messes up the HTML. Currently removing them. 


CHANGELOG
17-07-04        Version 1.0.1
Puts the last command back in the form for you.
