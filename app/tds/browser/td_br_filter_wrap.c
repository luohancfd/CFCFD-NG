...
extern int cfilter(Tcl_Interp *, char *,int); /* PJ */
extern int c_heat_transfer_emf(Tcl_Interp *, char *,double,double,double,double); /* PJ */
extern int c_heat_transfer_temp(Tcl_Interp *, char *,double,double,double,double); /* PJ */
extern int c_emf_temp(Tcl_Interp *, char *,double,double,double,double); /* PJ */
extern int c_surface_temperature(Tcl_Interp *, char *,double,double,double,double); /* PJ */
#ifdef __cplusplus
extern "C" {
#endif
static int
_wrap_cfilter(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 ;
    int arg2 ;
    int result;
    
    if (SWIG_GetArgs(interp, objc, objv,"si:cfilter vname nhalf ",&arg1,&arg2) == TCL_ERROR) SWIG_fail;
    result = (int)cfilter(interp, arg1,arg2); /* PJ */
...
static int
_wrap_c_heat_transfer_emf(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 ;
    double arg2 ;
    double arg3 ;
    double arg4 ;
    ...
    if (SWIG_GetArgs(interp, objc, objv,"sdddd:c_heat_transfer_emf vname dt rhock E a ",&arg1,&arg2,&arg3,&arg4,&arg5) == TCL_ERROR) SWIG_fail;
    result = (int)c_heat_transfer_emf(interp, arg1,arg2,arg3,arg4,arg5); /* PJ */
...
static int
_wrap_c_heat_transfer_temp(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 ;
    double arg2 ;
    double arg3 ;
    double arg4 ;
    ...
    if (SWIG_GetArgs(interp, objc, objv,"sdddd:c_heat_transfer_temp vname dt rhock E a ",&arg1,&arg2,&arg3,&arg4,&arg5) == TCL_ERROR) SWIG_fail;
    result = (int)c_heat_transfer_temp(interp, arg1,arg2,arg3,arg4,arg5); /* PJ */
...
static int
_wrap_c_emf_temp(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 ;
    double arg2 ;
    double arg3 ;
    double arg4 ;
    ...
    if (SWIG_GetArgs(interp, objc, objv,"sdddd:c_emf_temp vname dt rhock E a ",&arg1,&arg2,&arg3,&arg4,&arg5) == TCL_ERROR) SWIG_fail;
    result = (int)c_emf_temp(interp, arg1,arg2,arg3,arg4,arg5); /* PJ */
...
static int
_wrap_c_surface_temperature(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 ;
    double arg2 ;
    double arg3 ;
    double arg4 ;
    ...
    if (SWIG_GetArgs(interp, objc, objv,"sdddd:c_surface_temperature vname dt rhock E a ",&arg1,&arg2,&arg3,&arg4,&arg5) == TCL_ERROR) SWIG_fail;
    result = (int)c_surface_temperature(interp, arg1,arg2,arg3,arg4,arg5); /* PJ */
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "cfilter", (swig_wrapper_func) _wrap_cfilter, NULL},
    { SWIG_prefix "c_heat_transfer_emf", (swig_wrapper_func) _wrap_c_heat_transfer_emf, NULL},
    { SWIG_prefix "c_heat_transfer_temp", (swig_wrapper_func) _wrap_c_heat_transfer_temp, NULL},
    { SWIG_prefix "c_emf_temp", (swig_wrapper_func) _wrap_c_emf_temp, NULL},
    { SWIG_prefix "c_surface_temperature", (swig_wrapper_func) _wrap_c_surface_temperature, NULL},
    {0, 0, 0}
};
