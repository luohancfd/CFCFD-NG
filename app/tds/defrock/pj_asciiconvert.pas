...
begin
     ...
     if timewanted then
         writeln(textfile,t:14:-5,' ',y:14:-5)
     else
         writeln(textfile,y:14:-5);
end;
     ...
     begin
          ...
          begin
               ...
               begin
			    ...
			    writeln(textfile, '# timeStart ', timeStart:14);
			    writeln(textfile, '# timeAverageWindow ', averagetime:14);
			    writeln(textfile, '# timeInterval ', timeInterval:14);
                              writeln(textfile, '# timeUnits microseconds');
			    writeln(textfile, '# transducerSensitivity ', sensitivity[i]:14);
                              writeln(textfile, '# transducerSensitivityUnits volts/', unitarray[unitIndex]);
                              writeln(textfile, '# transducerName ', transducername[i]);
			    writeln(textfile, '# transducerLocation ', location[i]:14);
                              writeln(textfile, '# transducerSerialNumber ', serial_number[i]);
			    writeln(textfile, '# gain ', gain[i]:14);
			    writeln(textfile, '# qfluxgain ', qfluxgain[i]:14);
                              writeln(textfile, '');
