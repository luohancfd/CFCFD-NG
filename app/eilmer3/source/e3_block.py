...
# are defined by (A-face, B-face, orientation) tuples.
# This latter form is used in the C-code to decide where to transfer data
# at the block boundaries.
connectionDict3D = {}

# North-North
vpairs = [(3,2),(7,6),(6,7),(2,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, NORTH, 0)
vpairs = [(3,3),(7,2),(6,6),(2,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, NORTH, 1)
vpairs = [(3,7),(7,3),(6,2),(2,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, NORTH, 2)
vpairs = [(3,6),(7,7),(6,3),(2,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, NORTH, 3)
# North-South
vpairs = [(3,0),(7,4),(6,5),(2,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, SOUTH, 0)
vpairs = [(3,1),(7,0),(6,4),(2,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, SOUTH, 1)
vpairs = [(3,5),(7,1),(6,0),(2,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, SOUTH, 2)
vpairs = [(3,4),(7,5),(6,1),(2,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, SOUTH, 3)
# North-East
vpairs = [(3,1),(7,5),(6,6),(2,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, EAST, 0)
vpairs = [(3,2),(7,1),(6,5),(2,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, EAST, 1)
vpairs = [(3,6),(7,2),(6,1),(2,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, EAST, 2)
vpairs = [(3,5),(7,6),(6,2),(2,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, EAST, 3)
# North-West
vpairs = [(3,3),(7,7),(6,4),(2,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, WEST, 0)
vpairs = [(3,0),(7,3),(6,7),(2,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, WEST, 1)
vpairs = [(3,4),(7,0),(6,3),(2,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, WEST, 2)
vpairs = [(3,7),(7,4),(6,0),(2,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, WEST, 3)
# North-Top
vpairs = [(3,4),(7,7),(6,6),(2,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, TOP, 0)
vpairs = [(3,5),(7,4),(6,7),(2,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, TOP, 1)
vpairs = [(3,6),(7,5),(6,4),(2,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, TOP, 2)
vpairs = [(3,7),(7,6),(6,5),(2,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, TOP, 3)
# North-Bottom
vpairs = [(3,1),(7,2),(6,3),(2,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, BOTTOM, 0)
vpairs = [(3,0),(7,1),(6,2),(2,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, BOTTOM, 1)
vpairs = [(3,3),(7,0),(6,1),(2,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, BOTTOM, 2)
vpairs = [(3,2),(7,3),(6,0),(2,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (NORTH, BOTTOM, 3)

# South-North
vpairs = [(1,2),(5,6),(4,7),(0,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, NORTH, 0)
vpairs = [(1,3),(5,2),(4,6),(0,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, NORTH, 1)
vpairs = [(1,7),(5,3),(4,2),(0,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, NORTH, 2)
vpairs = [(1,6),(5,7),(4,3),(0,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, NORTH, 3)
# South-South
vpairs = [(1,0),(5,4),(4,5),(0,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, SOUTH, 0)
vpairs = [(1,1),(5,0),(4,4),(0,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, SOUTH, 1)
vpairs = [(1,5),(5,1),(4,0),(0,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, SOUTH, 2)
vpairs = [(1,4),(5,5),(4,1),(0,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, SOUTH, 3)
# South-East
vpairs = [(1,1),(5,5),(4,6),(0,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, EAST, 0)
vpairs = [(1,2),(5,1),(4,5),(0,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, EAST, 1)
vpairs = [(1,6),(5,2),(4,1),(0,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, EAST, 2)
vpairs = [(1,5),(5,6),(4,2),(0,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, EAST, 3)
# South-West
vpairs = [(1,3),(5,7),(4,4),(0,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, WEST, 0)
vpairs = [(1,0),(5,3),(4,7),(0,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, WEST, 1)
vpairs = [(1,4),(5,0),(4,3),(0,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, WEST, 2)
vpairs = [(1,7),(5,4),(4,0),(0,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, WEST, 3)
# South-Top
vpairs = [(1,4),(5,7),(4,6),(0,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, TOP, 0)
vpairs = [(1,5),(5,4),(4,7),(0,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, TOP, 1)
vpairs = [(1,6),(5,5),(4,4),(0,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, TOP, 2)
vpairs = [(1,7),(5,6),(4,5),(0,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, TOP, 3)
# South-Bottom
vpairs = [(1,1),(5,2),(4,3),(0,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, BOTTOM, 0)
vpairs = [(1,0),(5,1),(4,2),(0,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, BOTTOM, 1)
vpairs = [(1,3),(5,0),(4,1),(0,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, BOTTOM, 2)
vpairs = [(1,2),(5,3),(4,0),(0,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (SOUTH, BOTTOM , 3)

# East-North
vpairs = [(2,2),(6,6),(5,7),(1,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, NORTH, 0)
vpairs = [(2,3),(6,2),(5,6),(1,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, NORTH, 1)
vpairs = [(2,7),(6,3),(5,2),(1,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, NORTH, 2)
vpairs = [(2,6),(6,7),(5,3),(1,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, NORTH, 3)
# East-South
vpairs = [(2,0),(6,4),(5,5),(1,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, SOUTH, 0)
vpairs = [(2,1),(6,0),(5,4),(1,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, SOUTH, 1)
vpairs = [(2,5),(6,1),(5,0),(1,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, SOUTH, 2)
vpairs = [(2,4),(6,5),(5,1),(1,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, SOUTH, 3)
# East-East
vpairs = [(2,1),(6,5),(5,6),(1,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, EAST, 0)
vpairs = [(2,2),(6,1),(5,5),(1,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, EAST, 1)
vpairs = [(2,6),(6,2),(5,1),(1,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, EAST, 2)
vpairs = [(2,5),(6,6),(5,2),(1,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, EAST, 3)
# East-West
vpairs = [(2,3),(6,7),(5,4),(1,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, WEST, 0)
vpairs = [(2,0),(6,3),(5,7),(1,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, WEST, 1)
vpairs = [(2,4),(6,0),(5,3),(1,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, WEST, 2)
vpairs = [(2,7),(6,4),(5,0),(1,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, WEST, 3)
# East-Top
vpairs = [(2,4),(6,7),(5,6),(1,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, TOP, 0)
vpairs = [(2,5),(6,4),(5,7),(1,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, TOP, 1)
vpairs = [(2,6),(6,5),(5,4),(1,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, TOP, 2)
vpairs = [(2,7),(6,6),(5,5),(1,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, TOP, 3)
# East-Bottom
vpairs = [(2,1),(6,2),(5,3),(1,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, BOTTOM, 0)
vpairs = [(2,0),(6,1),(5,2),(1,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, BOTTOM, 1)
vpairs = [(2,3),(6,0),(5,1),(1,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, BOTTOM, 2)
vpairs = [(2,2),(6,3),(5,0),(1,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (EAST, BOTTOM, 3)

# West-North
vpairs = [(0,2),(4,6),(7,7),(3,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, NORTH, 0)
vpairs = [(0,3),(4,2),(7,6),(3,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, NORTH, 1)
vpairs = [(0,7),(4,3),(7,2),(3,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, NORTH, 2)
vpairs = [(0,6),(4,7),(7,3),(3,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, NORTH, 3)
# West-South
vpairs = [(0,0),(4,4),(7,5),(3,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, SOUTH, 0)
vpairs = [(0,1),(4,0),(7,4),(3,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, SOUTH, 1)
vpairs = [(0,5),(4,1),(7,0),(3,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, SOUTH, 2)
vpairs = [(0,4),(4,5),(7,1),(3,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, SOUTH, 3)
# West-East
vpairs = [(0,1),(4,5),(7,6),(3,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, EAST, 0)
vpairs = [(0,2),(4,1),(7,5),(3,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, EAST, 1)
vpairs = [(0,6),(4,2),(7,1),(3,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, EAST, 2)
vpairs = [(0,5),(4,6),(7,2),(3,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, EAST, 3)
# West-West
vpairs = [(0,3),(4,7),(7,4),(3,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, WEST, 0)
vpairs = [(0,0),(4,3),(7,7),(3,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, WEST, 1)
vpairs = [(0,4),(4,0),(7,3),(3,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, WEST, 2)
vpairs = [(0,7),(4,4),(7,0),(3,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, WEST, 3)
# West-Top
vpairs = [(0,4),(4,7),(7,6),(3,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, TOP, 0)
vpairs = [(0,5),(4,4),(7,7),(3,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, TOP, 1)
vpairs = [(0,6),(4,5),(7,4),(3,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, TOP, 2)
vpairs = [(0,7),(4,6),(7,5),(3,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, TOP, 3)
# West-Bottom
vpairs = [(0,1),(4,2),(7,3),(3,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, BOTTOM, 0)
vpairs = [(0,0),(4,1),(7,2),(3,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, BOTTOM, 1)
vpairs = [(0,3),(4,0),(7,1),(3,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, BOTTOM, 2)
vpairs = [(0,2),(4,3),(7,0),(3,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (WEST, BOTTOM, 3)

# Top-North
vpairs = [(5,2),(6,6),(7,7),(4,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, NORTH, 0)
vpairs = [(5,3),(6,2),(7,6),(4,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, NORTH, 1)
vpairs = [(5,7),(6,3),(7,2),(4,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, NORTH, 2)
vpairs = [(5,6),(6,7),(7,3),(4,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, NORTH, 3)
# Top-South
vpairs = [(5,0),(6,4),(7,5),(4,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, SOUTH, 0)
vpairs = [(5,1),(6,0),(7,4),(4,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, SOUTH, 1)
vpairs = [(5,5),(6,1),(7,0),(4,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, SOUTH, 2)
vpairs = [(5,4),(6,5),(7,1),(4,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, SOUTH, 3)
# Top-East
vpairs = [(5,1),(6,5),(7,6),(4,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, EAST, 0)
vpairs = [(5,2),(6,1),(7,5),(4,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, EAST, 1)
vpairs = [(5,6),(6,2),(7,1),(4,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, EAST, 2)
vpairs = [(5,5),(6,6),(7,2),(4,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, EAST, 3)
# Top-West
vpairs = [(5,3),(6,7),(7,4),(4,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, WEST, 0)
vpairs = [(5,0),(6,3),(7,7),(4,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, WEST, 1)
vpairs = [(5,4),(6,0),(7,3),(4,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, WEST, 2)
vpairs = [(5,7),(6,4),(7,0),(4,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, WEST, 3)
# Top-Top
vpairs = [(5,4),(6,7),(7,6),(4,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, TOP, 0)
vpairs = [(5,5),(6,4),(7,7),(4,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, TOP, 1)
vpairs = [(5,6),(6,5),(7,4),(4,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, TOP, 2)
vpairs = [(5,7),(6,6),(7,5),(4,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, TOP, 3)
# Top-Bottom
vpairs = [(5,1),(6,2),(7,3),(4,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, BOTTOM, 0)
vpairs = [(5,0),(6,1),(7,2),(4,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, BOTTOM, 1)
vpairs = [(5,3),(6,0),(7,1),(4,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, BOTTOM, 2)
vpairs = [(5,2),(6,3),(7,0),(4,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (TOP, BOTTOM, 3)

# Bottom-North
vpairs = [(0,2),(3,6),(2,7),(1,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, NORTH, 0)
vpairs = [(0,3),(3,2),(2,6),(1,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, NORTH, 1)
vpairs = [(0,7),(3,3),(2,2),(1,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, NORTH, 2)
vpairs = [(0,6),(3,7),(2,3),(1,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, NORTH, 3)
# Bottom-South
vpairs = [(0,0),(3,4),(2,5),(1,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, SOUTH, 0)
vpairs = [(0,1),(3,0),(2,4),(1,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, SOUTH, 1)
vpairs = [(0,5),(3,1),(2,0),(1,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, SOUTH, 2)
vpairs = [(0,4),(3,5),(2,1),(1,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, SOUTH, 3)
# Bottom-East
vpairs = [(0,1),(3,5),(2,6),(1,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, EAST, 0)
vpairs = [(0,2),(3,1),(2,5),(1,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, EAST, 1)
vpairs = [(0,6),(3,2),(2,1),(1,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, EAST, 2)
vpairs = [(0,5),(3,6),(2,2),(1,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, EAST, 3)
# Bottom-West
vpairs = [(0,3),(3,7),(2,4),(1,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, WEST, 0)
vpairs = [(0,0),(3,3),(2,7),(1,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, WEST, 1)
vpairs = [(0,4),(3,0),(2,3),(1,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, WEST, 2)
vpairs = [(0,7),(3,4),(2,0),(1,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, WEST, 3)
# Bottom-Top
vpairs = [(0,4),(3,7),(2,6),(1,5)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, TOP, 0)
vpairs = [(0,5),(3,4),(2,7),(1,6)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, TOP, 1)
vpairs = [(0,6),(3,5),(2,4),(1,7)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, TOP, 2)
vpairs = [(0,7),(3,6),(2,5),(1,4)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, TOP, 3)
# Bottom-Bottom
vpairs = [(0,1),(3,2),(2,3),(1,0)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, BOTTOM, 0)
vpairs = [(0,0),(3,1),(2,2),(1,3)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, BOTTOM, 1)
vpairs = [(0,3),(3,0),(2,1),(1,2)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, BOTTOM, 2)
vpairs = [(0,2),(3,3),(2,0),(1,1)]; vpairs.sort()
connectionDict3D[tuple(vpairs)] = (BOTTOM, BOTTOM, 3)
...
def connect_blocks_3D(A, B, vtx_pairs, with_udf=0, 
    ...
    # \end{redundant}
    try:
        faceA, faceB, orientation = connectionDict3D[tuple(vtx_pairs)]
        print "connectionDict3D lookup: faceA=", faceName[faceA], \
              "faceB=", faceName[faceB], "orientation=", orientation
    except KeyError:
        print "connect_blocks_3D(): error"
