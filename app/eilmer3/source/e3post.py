...
def write_heat_flux_profile(outputFileName, heat_flux_list_str, tindx, nblock, hf_data ):
    ...
    fp.write("# Column 2: Conductive heat flux, q_cond (W/m**2) | normal velocity of cL1 for non-wall boundary\n")
    fp.write("# Column 3: Diffusive heat flux, q_diff (W/m**2) | normal velocity of cL0 for non-wall boundary\n")
    fp.write("# Column 4: Radiative heat flux, q_rad (W/m**2) | normal velocity of cR0 for non-wall boundary\n")
    fp.write("# Column 5: Wall temperature, T_wall (K) | normal velocity of cR1 for non-wall boundary\n")
    fp.write("# Column 6: Cell temperature, T_cell (K) | cL1 length\n")
    fp.write("# Column 7: Cell density, rho_cell (kg/m**3) | cL0 length\n")
    fp.write("# Column 8: Cell normal velocity, un_cell (m/s) | cR0 length\n")
    fp.write("# Column 9: Ghost cell normal velocity, un_ghost_cell (m/s) | cR1 length\n")
