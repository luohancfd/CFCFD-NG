...
int copy_to_north_boundary_2D(Block *A, Block *B, int B_bndry, int type_of_copy, size_t time_level);
int copy_to_east_boundary_2D(Block *A, Block *B, int B_bndry, int type_of_copy, size_t time_level);
int copy_to_south_boundary_2D(Block *A, Block *B, int B_bndry, int type_of_copy, size_t time_level);
int copy_to_west_boundary_2D(Block *A, Block *B, int B_bndry, int type_of_copy, size_t time_level);
