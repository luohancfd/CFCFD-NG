...
--
-- Modified Oct-29-2010
-- Fabian Zander
-- Removed all backwards reaction rates so that only equilibrium is used in the calculation of these
-- for purposes of comparison with some other modelling
