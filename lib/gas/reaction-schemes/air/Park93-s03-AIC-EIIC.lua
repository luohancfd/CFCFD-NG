...
reaction{
   ...
   chemistry_energy_coupling={ {species='e_minus', mode='translation', model='associative ionization', alpha=0.1} },
   ec={model='from CEA curves',iT=0}
}
...
reaction{
   ...
   chemistry_energy_coupling={ {species='e_minus', mode='translation', model='electron impact ionization', T_I=158500.0} },
   ec={model='from CEA curves',iT=-1,species='e_minus',mode='translation'}
}
...
reaction{
   ...
   chemistry_energy_coupling={ {species='e_minus', mode='translation', model='electron impact ionization', T_I=168600.0} },
   ec={model='from CEA curves',iT=-1,species='e_minus',mode='translation'}
}
