...
function create_fully_coupled_four_temperature_gas(species, f)
   e_flag = false
   ...
   f:write("rotational = {}\n")
   f:write("rotational.type = 'variable Cv'\n")
   f:write("rotational.iT = 1\n")
   f:write("rotational.components = { 'all-rotation' }\n\n")
   f:write(string.format("rotational.T_min = %f\n",default.T_min))
   f:write(string.format("rotational.T_max = %f\n",default.T_max))
   f:write(string.format("rotational.iterative_method = '%s'\n",default.iterative_method))
   f:write(string.format("rotational.convergence_tolerance = %e\n",default.convergence_tolerance))
   f:write(string.format("rotational.max_iterations = %d\n\n",default.max_iterations))
   f:write("vibrational = {}\n")
   ...
   if e_flag then
      ...
      f:write("electronic.components = { 'all-electronic' }\n")
   end
   f:write(string.format("electronic.T_min = %f\n",default.T_min))
   f:write(string.format("electronic.T_max = %f\n",default.T_max))
   f:write(string.format("electronic.iterative_method = '%s'\n",default.iterative_method))
   f:write(string.format("electronic.convergence_tolerance = %e\n",default.convergence_tolerance))
   f:write(string.format("electronic.max_iterations = %d\n\n",default.max_iterations))
