...
--   12-Mar-2012 - added Bender real gas option (Peter Blyton)

require 'ideal_gas'
require 'thermally_perfect_gas'
require 'Noble_Abel_gas'
require 'van_der_Waals_gas'
require 'Bender_real_gas'
...
local create_Bender_real_gas = Bender_real_gas.create_Bender_real_gas
...
gas_models["Bender real gas"] = create_Bender_real_gas
