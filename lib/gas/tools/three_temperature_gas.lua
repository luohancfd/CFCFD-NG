...
function create_three_temperature_gas(species, f)
   e_flag = false
   ...
   f:write("thermal_modes = { 'transrotational', 'vibrational', 'electronic' }\n\n")
