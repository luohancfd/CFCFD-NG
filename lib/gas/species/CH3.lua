...
CH3.electronic_levels = {
   ...
   --                            (p_i)    (E_diss)                                              
   -- ==============================================================================================================================================
   ilev_0  = {  0.00,     1.079,    2,   93937.06,    0.0,      9.58,       0.000,     6,      0,        3004.4,     606.5,    3160.8,     1396.0 },
   ilev_1  = {  46239.0,  1.079,    2,   93937.06,    0.0,      9.58,       0.000,     6,      0,        2040.0,     606.5,    3160.8,     1396.0 },
   ilev_2  = {  59972.0,  1.079,    2,   93937.06,    0.0,      9.58,       0.000,     6,      0,        2931.0,     1323.0,   3087.0,     1428.0 },
   -- ==============================================================================================================================================
}
